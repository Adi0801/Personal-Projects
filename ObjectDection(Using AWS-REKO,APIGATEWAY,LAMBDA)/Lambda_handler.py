...
def lambda_handler(event, context):
    ...
    try:
        ...
        #The event is user will be sending data ,Api will called
        ...
        #Api call for Rekongition Service
        response = rekognition.detect_labels(
            Image={
                'Bytes': image_binary
            },
            MaxLabels=15,
            MinConfidence=70 #confidence consider as accuracy
        )

        # Extract only labels and confidence to show to user
        labels_info = [
            {
